<x-app-layout>
    ...
    <div class="row align-items-center mb-3 border-bottom no-gutters">
        ...
        <div class="col-auto">
            <a href="{{ route('admin.show', Hashids::encode($user->id)) }}" class="btn btn-sm btn-info text-white me-1">
                            ...
                            <div class="col-md-6 col-lg-6 mb-3">
                                <div class="form-group">
                                    ...
                                    @error('role')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Current: {{ $user->roles->first()?->name ? ucwords(str_replace('_', ' ', $user->roles->first()->name)) : 'No role assigned' }}</small>
                                </div>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                if (submitBtn) {
                    ...
                    submitBtn.innerHTML = '<i class="fe fe-loader spinning me-1"></i> Updating User...';
                }
            });
